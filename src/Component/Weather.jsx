...
const Weather = () => {
  ...
  return (
    <Container fluid className='w-100 border-danger  app border-4'>
    <Row className='border-primary m-0 p-0 d-flex align-items-start flex-row border-3'style={{overflow:"hidden"}}>
